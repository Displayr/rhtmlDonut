...
describe('tooltip_interaction', () => {
  ...
  test('user can hover over the segments and see hilighting and tooltips', async function () {
    ...
    await testSnapshots({ page, testName: 'A1_hover_over_segment_10_segment_highlighted_no_tooltip' })

    await donutPlot.hoverOverSegment(7)
    await testSnapshots({ page, testName: 'A2_hover_over_segment_7_segment_highlighted_get_a_tooltip' })

    await donutPlot.hoverOverSegmentThenMove(7, 7, 2)
    await testSnapshots({ page, testName: 'A3_hover_over_segment_7_and_move_segment_highlighted_tooltip_follows' })

    await donutPlot.moveMouseOffDonut()
    await testSnapshots({ page, testName: 'A4_hover_off_donut' })

    await donutPlot.hoverOverSegment(11)
    await testSnapshots({ page, testName: 'A5_hover_over_segment_11_segment_and_label_are_hilighted' })

    await donutPlot.hoverOverLabel(12)
    await testSnapshots({ page, testName: 'A6_hover_over_label_12_segment_and_label_are_hilighted' })
  ...
  test('user can hover over the group segments and see tooltips', async function () {
    ...
    await testSnapshots({ page, testName: 'B1_hover_over_group_segment_0_no_tooltip' })

    await donutPlot.hoverOverGroupSegment(2)
    await testSnapshots({ page, testName: 'B2_hover_over_group_segment_2_see_a_tooltip' })
  ...
  test('tooltip wrapping default settings', async function () {
    ...
    await testSnapshots({ page, testName: 'C1A_segment_tooltip_wrapping_default_settings' })

    await donutPlot.hoverOverGroupSegment(2)
    await testSnapshots({ page, testName: 'C2A_group_segment_tooltip_wrapping_default_settings' })
  ...
  test('tooltip wrapping settings at max 10 percent', async function () {
    ...
    await donutPlot.hoverOverSegment(29)
    await testSnapshots({ page, testName: 'C1B_segment_tooltip_wrapping_short_wrapping' })

    await donutPlot.hoverOverGroupSegment(2)
    await testSnapshots({ page, testName: 'C2B_group_segment_tooltip_wrapping_short_wrapping' })
  ...
  test('tooltip styling is configurable', async function () {
    ...
    await donutPlot.hoverOverSegment(29)
    await testSnapshots({ page, testName: 'C1C_segment_tooltip_styling' })

    await donutPlot.hoverOverGroupSegment(2)
    await testSnapshots({ page, testName: 'C2C_group_segment_tooltip_styling' })
  ...
  test('tooltip autocoloring', async function () {
    ...
    await donutPlot.hoverOverSegment(29)
    await testSnapshots({ page, testName: 'D1_segment_autocolor' })

    await donutPlot.hoverOverSegment(26)
    await testSnapshots({ page, testName: 'D2_segment_autocolor_tooltip_should_be_different_color' })

    await donutPlot.hoverOverGroupSegment(2)
    await testSnapshots({ page, testName: 'D3_group_segment_autocolor' })

    await donutPlot.hoverOverGroupSegment(4)
    await testSnapshots({ page, testName: 'D4_group_segment_autocolor_tooltip_should_be_different_color' })
