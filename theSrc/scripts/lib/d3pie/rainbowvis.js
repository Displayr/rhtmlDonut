...
function ColourGradient () {
  ...
  function calcHex (number, channelStartBase16, channelEndBase16) {
    ...
    let cStartBase10 = parseInt(channelStartBase16, 16)
    let cEndBase10 = parseInt(channelEndBase16, 16)
    let cPerUnit = (cEndBase10 - cStartBase10) / numRange
    let cBase10 = Math.round(cPerUnit * (num - minNum) + cStartBase10)
    return formatHex(cBase10.toString(16))
  }
